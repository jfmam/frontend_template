  ...
  return (
    <div className={cx('center')}>
      ...
      <span className={cx('arrow-logo')}>
        <img width="100%" height="100%" sizes="(max-width: 425px) 59px, 18.93px" src="/arrow.svg" alt="" loading="eager" />
      </span>
    </div>
  );
}
  ...
  return (
    <div className={cx('center')}>
      <span className={cx('won-logo')}>
        <img width="100%" height="100%" sizes="(max-width: 425px) 42px, 24.71px" src="/won.svg" alt="" loading="eager" />
      </span>
      <>
        (
        <Input
